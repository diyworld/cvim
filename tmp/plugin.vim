...
map <space>bd :Bclose<cr>:tabclose<cr>gT
...
noremap <space>th  mmHmt:%s/<C-V><cr>//ge<cr>'tzt'm
" 文档转换为 unix格式
noremap <space>tu :set fileformat=unix
...
map <space>tp :setlocal paste!<cr>
